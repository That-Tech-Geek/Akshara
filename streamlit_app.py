...
lesson_contents = {
    ...
    "Emergency Funds": "Emergency funds serve as a financial cushion for unexpected expenses like medical emergencies, job loss, or urgent repairs. Building an emergency fund involves setting aside 3–6 months’ worth of living expenses in a liquid, easily accessible account. For example, a family spending ₹50,000 monthly on essentials should aim to save ₹1.5–3 lakh in their emergency fund. Households can contribute to this fund by redirecting small windfalls, such as tax refunds, bonuses, or unused budgeted amounts. For example, a family that saves ₹2,000 monthly by skipping coffee shop visits can accumulate ₹24,000 annually, significantly boosting their emergency reserve. Families should avoid using these funds for discretionary expenses and instead rely on budgeting for non-emergencies. By consistently building and maintaining an emergency fund, households safeguard themselves from financial instability during crises, ensuring that they can meet urgent needs without resorting to debt.", 
}
